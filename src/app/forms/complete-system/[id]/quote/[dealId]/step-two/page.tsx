...
import StepTwoCompleteSystem from "./StepTwoCompleteSystem";
...
export const metadata: Metadata = {
  title: "Complete System Quote - Step Two",
  description: "Review and finalize your complete system quote",
};
